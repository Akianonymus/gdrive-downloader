...
_download_with_aria2c() {
    ...
    # flag, flag_value and url var is modified by this function and later used
...
###################################################
# A extra wrapper for _download_file_[aria|curl] function to properly handle retries
